		...
		<div class="panel panel-primary panel-default content-panel">
			<div class="panel-body">
				<table class="form-table">
					...
					<tr class="radio-span" style="border-bottom:none;">
						<td>
							<textarea rows="6"  class="pro_text" id="google_al" name="google_al" placeholder="<?php _e('Enter Your Google Analytics Here within proper code format......','WPSM_RCS_TEXT_DOMAIN'); ?>"><?php echo $wpsm_rcs_plugin_options_header['google_al']; ?></textarea>
						</td>
					</tr>
				</table>
			</div>
