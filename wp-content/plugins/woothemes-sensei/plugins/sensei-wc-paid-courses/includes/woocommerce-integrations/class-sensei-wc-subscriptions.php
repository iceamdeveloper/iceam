...
class Sensei_WC_Subscriptions {
	...
	public static function get_subscription_permission( $user_access_permission, $user_id ) {
		...
		if ( $user_has_access_through_a_subscription ) {
			...
			Sensei()->permissions_message['title']   = __( 'No active subscription', 'sensei-wc-paid-courses' );
			Sensei()->permissions_message['message'] = __( 'Sorry, you do not have an access to this content without an active subscription.', 'sensei-wc-paid-courses' );
