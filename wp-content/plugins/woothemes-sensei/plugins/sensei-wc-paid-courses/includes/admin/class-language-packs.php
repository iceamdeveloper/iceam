<?php
/**
 * File containing the class \Sensei_WC_Paid_Courses\Admin\Language_Packs.
 *
 ...
 *
 * @class Sensei_WC_Paid_Courses\Admin\Language_Packs
 */
final class Language_Packs {
	const BASE_PACKAGE_URL         = 'https://raw.githubusercontent.com/Automattic/sensei-wc-paid-courses-language-packs/master/packages';
	const PLUGIN_TEXT_DOMAIN       = 'sensei-wc-paid-courses';
	const REMOTE_PACKAGE_TRANSIENT = 'sensei-wc-paid-courses-translations-';
	...
	private function prepare_package( $locale, $package ) {
		...
		$package['version']    = SENSEI_WC_PAID_COURSES_VERSION;
	...
	/**
	 * Gets the remote package meta information for this version of Sensei WC Paid Courses.
	 *
	 * @return array
	 */
	private function get_version_package_data() {
		...
		$response = wp_safe_remote_get( sprintf( self::BASE_PACKAGE_URL . '/%s/index.json', SENSEI_WC_PAID_COURSES_VERSION ) );
