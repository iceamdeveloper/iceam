...
return{term:e.term,
//search term
page:e.page||1,action:"sensei_json_search_courses",security:window.modulesAdmin.search_courses_nonce,default:""}},processResults:function(e,o){var r=[];
 ...
 * @returns {string}
 */
function(e){e=e.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var o=new RegExp("[\\?&]"+e+"=([^&#]*)").exec(location.search);return null===o?"":decodeURIComponent(o[1].replace(/\+/g," "))}("post"),r=jQuery(this).parent().children("#newmodule"),t=jQuery(this).parent().children("#add_module_nonce"),s=jQuery("#module_course_mb #taxonomy-module #module-all ul#modulechecklist"),u=r.val(),n=t.val();if(e.isEmpty(u)||e.isEmpty(n))r.focus();else{var a={newTerm:u,security:n,action:"sensei_add_new_module_term",course_id:o,from_page:"course"};jQuery.post(ajaxurl,a,(function(o){var t,u;if(o.success){
// make sure the return values are valid
if(t=o.data.termId,u=o.data.termName,!(parseInt(t)>0)||e.isEmpty(u))return void r.focus();
// setup the new list item
var n='<li id="module-'+t+'">';return n+='<label class="selectit">',n+='<input value="'+t+'" type="checkbox" checked="checked" name="tax_input[module][]" id="in-module-'+t+'">',n+=u,n+="</label></li>",
// ad the list item
s.prepend(n),
// clear the input
r.val(""),void r.focus()}if(void 0!==o.data.errors&&void 0!==o.data.errors.term_exists){t=o.data.term.id;
// find term with id and just make sure it is
var a=s.find("#module-"+t+" input");
...
/**
   ...
   */
var o=document.querySelector('select[name="sensei-course-teacher-author"]');o&&o.addEventListener("change",(function(){var e=document.querySelector("#module_course_mb");e&&e.parentNode.removeChild(e)})),
