...
?>
<div id="wc_aelia_cs_bundle_prices" class="clearfix show_if_bundle">
<?php
	// Debug
	// echo 'DEBUG - BUNDLE';
...
<?php
// TODO Implement Admin UI to allow entering prices in multiple currencies
// The code below refers to the Subscriptions integration, it can be used as
// a guideline
